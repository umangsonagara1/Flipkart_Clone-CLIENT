  ...
  return (
    <>
        ...
        <Typography style={{marginTop: 5, color:'#878787', fontsize: 14}}>
            8 Ratings & 1 Reviews
            <Box component="span"><img src={fassured} style={{ width: 70, margineLeft: 20 }} /></Box>
        </Typography>
        <Typography>
        ...
        <SmallText>
            <Typography><StyledBadge />Get extra 20% off ₹50 on 1 item(s) T&C </Typography>
        ...
        <Table>
            <TableBody>
                ...
                <ColumnText>
                    <TableCell style={{ color: '#878787'}}>Wraranty</TableCell>
